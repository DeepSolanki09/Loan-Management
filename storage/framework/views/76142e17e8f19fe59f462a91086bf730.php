...
<head>
    ...
    <!-- Google font -->
    <link href="<?php echo e(asset('css/new/google_fonts2')); ?>" rel="stylesheet">
        ...
        <div class="loan-cards">
            <?php $__currentLoopData = $loans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $loan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="card loan-item"
                    data-bank="<?php echo e(strtolower($loan->bank_name)); ?>"
                    data-type="<?php echo e(strtolower($loan->loan_type)); ?>">
                           
                           <img src="<?php echo e(asset('storage/' . $loan->bank_logo)); ?>">
                           <h2><?php echo e($loan->loan_type); ?></h2>
                           <p>Bank: <?php echo e($loan->bank_name); ?></p>
                           <p>Interest Rate: <?php echo e($loan->interest_rate); ?>% per annum</p>
                           <p>Loan Tenure: Up to <?php echo e($loan->loan_tenure); ?> years</p>
                           <a href="<?php echo e(route('loan.details.show', ['loan_id' => $loan->loan_id])); ?>"  class="apply-btn">Know More</a>
                           <!-- <a href="<?php echo e(route('loans.create', ['loan_type' => $loan->loan_type, 'bank_name' => $loan->bank_name, 'loan_id' => $loan->loan_id])); ?>" class="apply-btn">Apply Now</a> -->
                        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\Deep\Laravel Project\Loan Management\resources\views/loan.blade.php ENDPATH**/ ?>