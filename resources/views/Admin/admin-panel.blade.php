...
<div class="wrapper">
    ...
    <aside class="sidebar">
        <a href="#" class="site-logo">
            <a href="/admin-panel"><img src="{{ asset('Images/logo.png') }}" alt="Logo"></a>
        </a>
        ...
        <div class="dashboard-navbar">
            ...
            <div class="user-profile">
                <a href="{{ route('profile') }}">
                    <img src="{{ asset(Auth::user()->profile_pic ? 'storage/' . Auth::user()->profile_pic : 'default-profile.png') }}">
                </a>&nbsp;&nbsp;&nbsp;
