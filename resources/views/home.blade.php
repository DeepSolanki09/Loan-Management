...
<body>
	...
	<section class="hero-section" style="margin-top:74px;">
		...
		<div class="hero-slider owl-carousel">
			<div class="hs-item set-bg" data-setbg="{{ asset('Images/hero-slider/1.jpg') }}"></div>
			<div class="hs-item set-bg" data-setbg="{{ asset('Images/hero-slider/2.jpg') }}"></div>
			<div class="hs-item set-bg" data-setbg="{{ asset('Images/hero-slider/3.jpg') }}"></div>
		</div>
	</section>
	<!-- Hero Section end -->
	...
	<!-- CTA Section end -->
	<section class="cta-section set-bg" data-setbg="{{ asset('Images/cta-bg.jpg') }}">
		<div class="container">
				...
				<div class="row">
					...
					<div class="col-lg-6">
						<div class="feature-text">
							...
							<a href="" class="readmore">Apply for a loan now <img src="{{ asset('Images\arrow.png') }}" alt=""></a>
						</div>
					</div>
				</div>
			</div>
	...
	<section class="info-section spad">
		<div class="container">
			<div class="row">
				<div class="col-lg-5">
					<img src=" {{ asset('Images\info-img.jpg') }}" alt="">
				</div>
				<div class="col-lg-7">
					<div class="info-text">
						...
						<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tem por incididunt ut labore et dolore mag na aliqua.  Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Suspendisse potenti. Ut gravida mattis magna, non varius lorem sodales nec. In libero orci, ornare non nisl.</p>
						<a href="" class="readmore">Contact Us Now <img src=" {{ asset('Images\arrow.png') }}" alt=""></a>
	...
	<!-- Score Section end -->
	<section class="score-section text-white set-bg" data-setbg=" {{ asset('Images/score-bg.jpg')}}">
		<div class="container">
			<div class="row">
			...
			<img src="{{ asset('Images\hand.png') }}" alt="" class="hand-img">
		</div>
	</section>
	<!-- Score Section end -->
