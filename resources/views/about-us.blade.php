...
@include('navbar')
	...
	<section class="page-top-section set-bg" data-setbg="{{ asset('Images/page-top-bg/1.jpg') }}">
		<div class="container">
			<h2>About us</h2>
			...
			<div class="row">
				<div class="col-lg-4">
					<div class="authoritie-item">
						...
						<a href="./loans.php" class="readmore">Apply for a loan now <img src=" {{ asset('Imagesss/arrow.png') }}" alt=""></a>
					</div>
				</div>
				<div class="col-lg-4">
					<div class="authoritie-item">
						<img src="{{ asset('Images/brands/2.png') }}" alt="">
				...
				<div class="col-lg-4">
					<div class="authoritie-item">
						<img src="{{ asset('Images/brands/3.png') }}" alt="">
						<h4>Peer-to-Peer Finance Association</h4>
						<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tem por incididunt ut labore et dolore mag na aliqua.  Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos hime-naeos. Suspendisse potenti. Ut gravida mattis magna, non varius lorem sodales nec. In libero orci, ornare non nisl.</p>
						<a href="./loans.php" class="readmore">Apply for a loan now <img src="{{  asset('Images/arrow.png') }}" alt=""></a>
					</div>
				</div>
			</div>
		</div>
